...
public class PopulationInitializer {
	 ...
	 * @param nbAnimal
	 *            the number of animals in the simulation
	 * @param nbHumans
	 *            the number of humans in the simulation
	 */
	public PopulationInitializer(Map map, int maxDayRecover, int maxDayDead, int nbAnimal, int nbHumans) {
