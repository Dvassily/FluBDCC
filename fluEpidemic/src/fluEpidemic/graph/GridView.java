...
public class GridView extends JFrame implements SimulatorView {
    ...
    public void showStatus(int step, Field field) {
        ...
        for (int row = 0; row < field.getVerticalDimensions(); row++) {
            for (int col = 0; col < field.getHorizontalDimensions(); col++) {
                Entity entity = field.reportEntity(col, row);
                if (entity != null) {
